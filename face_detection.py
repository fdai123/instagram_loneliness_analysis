...
# , "gender", "headPose", "smile", "facialHair", "glasses", "emotion", "hair", "makeup", "occlusion", "accessories", "blur", "exposure", "noise", "qualityForRecognition"

from PIL import Image
img = open('./252288878_271860704727291_8142963701425031159_n_17926857349794901.jpg', 'rb')
detected_faces = face_client.face.detect_with_stream(img, return_face_landmarks=False, return_face_attributes=["age", "gender", "headPose", "smile", "facialHair", "glasses", "emotion", "hair", "makeup", "occlusion", "accessories", "blur", "exposure", "noise", "qualityForRecognition"], detection_model='detection_01', recognition_model='recognition_03')
